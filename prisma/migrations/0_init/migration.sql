...
-- AddForeignKey
ALTER TABLE "order" ADD CONSTRAINT "order_restaurant_table_id_fkey" FOREIGN KEY ("restaurant_table_id") REFERENCES "restaurant_table"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "restaurant_table" ADD CONSTRAINT "restaurant_table_table_status_id_fkey" FOREIGN KEY ("table_status_id") REFERENCES "table_status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
