...
import { getRestaurantTableById } from 'apiSdk/restaurant-tables';
...
function RestaurantTableViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<RestaurantTableInterface>(
    ...
    () =>
      getRestaurantTableById(id, {
        relations: ['restaurant', 'table_status', 'order'],
      }),
  );
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Restaurant Table Detail View
          </Text>
          {hasAccess('restaurant_table', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/restaurant-tables/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              ...
              {hasAccess('table_status', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/table-statuses/view/${data?.table_status?.id}`}>
              ...
              {hasAccess('order', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/orders/create?restaurant_table_id=${data?.id}`}>
